...
async function getPost() {
  ...
  if (data.status != 200) {
    await router.push({path: `/admin/post`});
  }
  ...
  <div class="p-10 flex w-full justify-around">
    ...
    <div class="w-1/3">
      ...
      <div class="p-3 rounded-xl bg-gray-50 border-2 border-gray-300">
        ...
        <div class="mt-4">
          <div class="sm:col-span-3">
            <label for="name"
                   class="block text-sm font-medium leading-6 text-gray-900 font-bold text-lg">Url/Link: </label>
            <div class="mt-2">
              <input
        ...
        <div class="mt-10">
          <div class="sm:col-span-3">
            <label for="bestand"
                   class="block text-sm font-medium leading-6 text-gray-900 font-bold text-lg">Afbeelding: </label>
            <div class="mt-2">
              <input
    ...
    <div class="w-1/3">
      ...
      <div class="p-3 rounded-xl bg-gray-50 flex justify-center border-2 border-gray-300">
        <Post v-if="State.itemLoaded" :name="postItem.data.name" :url="postItem.data.url" :admin="true"
              :image="postItem.data.image?.url ?? '' " :raw-image="postItem.data.image?.url ?? '' "/>
      </div>
    </div>
